...
export default function PrizeSection() {
  const prizes = [
    { rank: "1st Place", amount: "Rs. 1,00,000", icon: <Trophy className="w-12 h-12 text-[#00a884]" />, desc: "Winner's Trophy, Swags", color: "from-[#00a884]/20 to-[#00a884]/5", border: "border-[#00a884]/50", bg: "bg-white" },
